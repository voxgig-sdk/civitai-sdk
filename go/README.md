...
The Golang SDK for the Civitai API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/civitai-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/civitai-sdk=../path/to/github.com/voxgig-sdk/civitai-sdk
```
...
```
github.com/voxgig-sdk/civitai-sdk/
...
The root package (`github.com/voxgig-sdk/civitai-sdk`) re-exports everything needed
