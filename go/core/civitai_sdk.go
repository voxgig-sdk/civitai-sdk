...
func (sdk *CivitaiSDK) OptionsMap() map[string]any {
...
func (sdk *CivitaiSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *CivitaiSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *CivitaiSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CivitaiSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *CivitaiSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *CivitaiSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("CivitaiSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *CivitaiSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *CivitaiSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("CivitaiSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
