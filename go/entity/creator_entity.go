...
func NewCreatorEntity(client *core.CivitaiSDK, entopts map[string]any) *CreatorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CreatorEntity) GetName() string { return e.name }
...
func (e *CreatorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CreatorEntity) Deleted() bool {
	return e.deleted
}


func (e *CreatorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCreatorEntity(e.client, opts)
}

func (e *CreatorEntity) Data(args ...any) any {
...
func (e *CreatorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Creator; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CreatorEntity) DataTyped(data ...Creator) Creator {
	if len(data) > 0 {
		return typedFrom[Creator](e.Data(asMap(data[0])))
	}
	return typedFrom[Creator](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Creator (all fields
// optional at the wire level).
func (e *CreatorEntity) MatchTyped(match ...Creator) Creator {
	if len(match) > 0 {
		return typedFrom[Creator](e.Match(asMap(match[0])))
	}
	return typedFrom[Creator](e.Match())
}
...
func (e *CreatorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CreatorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CreatorEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CreatorListMatch and returns []Creator. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CreatorEntity) ListTyped(reqmatch CreatorListMatch, ctrl map[string]any) ([]Creator, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Creator](res), nil
}



func (e *CreatorEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CreatorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CreatorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CreatorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
