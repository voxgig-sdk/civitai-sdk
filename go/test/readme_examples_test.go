...
const testSeed = `map[string]any{"entity": map[string]any{"creator": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "image": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "model": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "model_version": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tag": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
