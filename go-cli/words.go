...
func registerSDKWords(r *eng.Registry, client *sdk.CivitaiSDK) {
...
func runOp(client *sdk.CivitaiSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
