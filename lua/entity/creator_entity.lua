...
local CreatorEntity = {}
CreatorEntity.__index = CreatorEntity


function CreatorEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CreatorEntity)
  self._name = "creator"
  self._client = client
...
function CreatorEntity:get_name()
  return self._name
end


function CreatorEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CreatorEntity.new(self._client, opts)
end
...
function CreatorEntity:mark_deleted()
  self._deleted = true
end


function CreatorEntity:deleted()
  return true == self._deleted
end


function CreatorEntity:data_set(args)
  if args ~= nil then
...
function CreatorEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CreatorEntity:match_set(args)
  if args ~= nil then
...
function CreatorEntity:match_get()
...
function CreatorEntity:stream(action, args, callopts)
...
---@param reqmatch CreatorListMatch
---@param ctrl? table
---@return Creator[]
---@return string? err
function CreatorEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CreatorEntity:_run_op(ctx, post_done)
  local utility = self._utility
