...
describe("CreatorDirect", function()
  it("should direct-list-creator", function()
    local setup = creator_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-creator", setup.live and "live" or "unit")
...
function creator_direct_setup(mockres)
