...
-- data to return.
local TEST_SEED = '{ entity = { ["creator"] = { ["test01"] = { id = "test01" } }, ["image"] = { ["test01"] = { id = "test01" } }, ["model"] = { ["test01"] = { id = "test01" } }, ["model_version"] = { ["test01"] = { id = "test01" } }, ["tag"] = { ["test01"] = { id = "test01" } } } }'
