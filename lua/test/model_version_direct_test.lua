...
describe("ModelVersionDirect", function()
  it("should direct-load-model_version", function()
    local setup = model_version_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-model_version", setup.live and "live" or "unit")
...
function model_version_direct_setup(mockres)
