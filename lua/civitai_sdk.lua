...
CivitaiSDK._make_feature = _make_feature


function CivitaiSDK.new(options)
  local self = setmetatable({}, CivitaiSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function CivitaiSDK:options_map()
...
function CivitaiSDK:get_utility()
  return Utility.copy(self._utility)
end


function CivitaiSDK:get_root_ctx()
  return self._rootctx
end


function CivitaiSDK:prepare(fetchargs)
...
function CivitaiSDK:direct(fetchargs)
...
-- by passing it.
function CivitaiSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function CivitaiSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "CivitaiSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function CivitaiSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = CivitaiSDK.new(sdkopts)
  sdk.mode = "test"
