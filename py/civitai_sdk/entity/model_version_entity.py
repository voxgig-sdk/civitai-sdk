...
from civitai_sdk.civitai_types import (
    ModelVersion,
...
class ModelVersionEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ModelVersionEntity(self._client, opts)
    ...
    def data_get(self) -> ModelVersion:
    ...
    def match_get(self) -> ModelVersion:
    ...
    def load(self, reqmatch=None, ctrl=None) -> ModelVersion:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.ModelVersion().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
