...
from civitai_sdk.utility import register

# Load features
from civitai_sdk.feature.base_feature import CivitaiBaseFeature
from civitai_sdk.features import _has_feature, _make_feature
...
class CivitaiSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = CivitaiUtility()
        self._utility = utility

        from civitai_sdk.config import shared_config
    ...
    def get_utility(self):
        return CivitaiUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("CivitaiSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def ModelVersion(self, data=None) -> "ModelVersionEntity":
        ...
        from civitai_sdk.entity.model_version_entity import ModelVersionEntity
        return ModelVersionEntity(self, data)


    def Tag(self, data=None) -> "TagEntity":
        """Entity factory: client.Tag().list() / client.Tag().load({"id": ...})."""
        from civitai_sdk.entity.tag_entity import TagEntity
