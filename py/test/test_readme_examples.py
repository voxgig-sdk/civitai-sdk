# Civitai SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions CivitaiSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both CivitaiSDK(...) and CivitaiSDK.test(...) become
#      CivitaiSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "civitai_sdk"
_SDK_CLASS = "CivitaiSDK"
