...
class CreatorEntity
  ...
  def make
    opts = @_entopts.dup
    CreatorEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [CreatorListMatch, Hash, nil] match filter (any subset of
  #   Creator fields); defaults to nil, treated as an empty match that lists all.
