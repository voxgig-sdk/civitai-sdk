...
class ModelVersionEntity
  ...
  def make
    opts = @_entopts.dup
    ModelVersionEntity.new(@_client, opts)
  end
  ...
  # @return [ModelVersion, Hash] the current ModelVersion data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of ModelVersion fields)
  def match_get
