...
module CivitaiTestRunner
  ...
  def self.env_override(m)
    live = getenv("CIVITAI_TEST_LIVE")
    override = getenv("CIVITAI_TEST_OVERRIDE")
    ...
    explain = getenv("CIVITAI_TEST_EXPLAIN")
    m["CIVITAI_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = CivitaiTestRunner
Helpers = CivitaiHelpers
Vs = VoxgigStruct
