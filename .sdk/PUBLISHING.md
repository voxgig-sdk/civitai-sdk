...
|---|---|---|
| `ts/` | @voxgig-sdk/civitai-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/civitai-sdk \
      --repository voxgig-sdk/civitai-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/civitai-sdk` shows it, and
`npm trust revoke @voxgig-sdk/civitai-sdk --id=<id>` removes it.
