...
// Civitai SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = CivitaiOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(CivitaiOmni::structfix($now, Struct::undef()))
                        !== json_encode(CivitaiOmni::structfix($val, Struct::undef()))) {
