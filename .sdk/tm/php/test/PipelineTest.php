...
{
    private static function utility(): CivitaiUtility
    {
        return new CivitaiUtility();
    }
    ...
    private static function ctx(array $over = []): CivitaiContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new CivitaiContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new CivitaiOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof CivitaiError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new CivitaiOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = CivitaiMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new CivitaiOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = CivitaiMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new CivitaiOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = CivitaiMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CivitaiSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = CivitaiMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new CivitaiResponse([]),
            'result' => new CivitaiResult([]),
        ]);
        [, $err] = CivitaiMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new CivitaiSpec([]),
            'response' => null,
            'result' => new CivitaiResult([]),
        ]);
        [, $err] = CivitaiMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new CivitaiSpec(['step' => 's']),
            'response' => new CivitaiResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new CivitaiResult([]),
        ]);
        [, $err] = CivitaiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new CivitaiSpec(['step' => 's']),
            'response' => new CivitaiResponse(self::resp(200, ['v' => 1])),
            'result' => new CivitaiResult([]),
        ]);
        [, $err] = CivitaiMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new CivitaiSpec(['step' => 's']),
            'response' => new CivitaiResponse(self::resp(200, ['v' => 2])),
            'result' => new CivitaiResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        CivitaiMakeResponse::call($ctx);
    ...
    {
        $preset = new CivitaiResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new CivitaiSpec([]),
            'response' => new CivitaiResponse([]),
            'result' => new CivitaiResult([]),
        ...
        [$got, $err] = CivitaiMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new CivitaiResult([])]);
        [, $err] = CivitaiMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new CivitaiSpec([]), 'result' => null]);
        [, $err] = CivitaiMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CivitaiSpec(['step' => 's']),
            'result' => new CivitaiResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new CivitaiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CivitaiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new CivitaiSpec(['step' => 's']),
            'result' => new CivitaiResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new CivitaiOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = CivitaiMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new CivitaiResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new CivitaiSpec([]),
            'result' => new CivitaiResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = CivitaiMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CivitaiMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new CivitaiError('boom', 'boom');
        $utility->fetcher = function (CivitaiContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CivitaiSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = CivitaiMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (CivitaiContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = CivitaiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(CivitaiResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (CivitaiContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new CivitaiSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = CivitaiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new CivitaiResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new CivitaiSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = CivitaiMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = CivitaiMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = CivitaiMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new CivitaiResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, CivitaiDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new CivitaiResult(['ok' => false])]);
        $this->expectException(CivitaiError::class);
        CivitaiDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new CivitaiResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', CivitaiMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        CivitaiMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new CivitaiBaseFeature();
        $b = new CivitaiBaseFeature();
        CivitaiFeatureAdd::call($ctx, $a);
        CivitaiFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): CivitaiBaseFeature
    {
        $f = new CivitaiBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        CivitaiFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): CivitaiContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new CivitaiSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = CivitaiPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new CivitaiResponse(['headers' => null]),
            'result' => new CivitaiResult([]),
        ]);
        CivitaiResultHeaders::call($ctx);
