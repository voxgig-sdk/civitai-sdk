...
class CivitaiGraphql
{
    ...
    // equivalent.
    public static function body(CivitaiContext $ctx): mixed
    {
    ...
    public static function errors(CivitaiContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
