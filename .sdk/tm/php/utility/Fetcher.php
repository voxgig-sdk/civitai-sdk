...
class CivitaiFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; CivitaiSDK/1.0)';
    ...
    public static function call(CivitaiContext $ctx, string $fullurl, array $fetchdef): array
    {
