...
// Civitai SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class CivitaiMakeRequest
{
    public static function call(CivitaiContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new CivitaiResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new CivitaiResponse($fetched);
        } else {
