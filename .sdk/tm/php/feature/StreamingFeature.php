...
class CivitaiStreamingFeature extends CivitaiBaseFeature
{
    ...
    private function _iterate(CivitaiResult $result): \Generator
    {
    ...
    private function _streamable(CivitaiContext $ctx): bool
    {
