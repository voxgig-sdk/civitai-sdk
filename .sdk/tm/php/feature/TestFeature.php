...
// Civitai SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class CivitaiTestFeature extends CivitaiBaseFeature
{
    ...
    public function init(CivitaiContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (CivitaiContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (CivitaiContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(CivitaiContext $ctx, $op, $args): array
    {
