...
class CivitaiRbacFeature extends CivitaiBaseFeature
{
    ...
    private function _required(CivitaiContext $ctx): ?string
    {
    ...
    private function _reject(CivitaiContext $ctx, string $required): void
    {
    ...
    private function _track(CivitaiContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
