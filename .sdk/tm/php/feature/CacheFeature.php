...
class CivitaiCacheFeature extends CivitaiBaseFeature
{
    ...
    private function _through(CivitaiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
