...
class CivitaiNetsimFeature extends CivitaiBaseFeature
{
    ...
    private function _simulate(CivitaiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(CivitaiContext $ctx, array $applied): void
    {
        $client = $this->client;
