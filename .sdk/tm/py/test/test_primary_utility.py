...
from projectname_sdk import CivitaiSDK
from projectname_sdk.core.spec import CivitaiSpec
from projectname_sdk.core.result import CivitaiResult
from projectname_sdk.core.response import CivitaiResponse
from projectname_sdk.core.operation import CivitaiOperation
from projectname_sdk.core.error import CivitaiError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import CivitaiBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = CivitaiSDK.test(None, None)
        ...
        class TestInitFeature(CivitaiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(CivitaiBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = CivitaiSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = CivitaiSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = CivitaiSDK.test(None, setup_opts)
