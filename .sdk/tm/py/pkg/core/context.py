...
from projectname_sdk.core.control import CivitaiControl
...
class CivitaiContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, CivitaiResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return CivitaiError(code, msg, self)
