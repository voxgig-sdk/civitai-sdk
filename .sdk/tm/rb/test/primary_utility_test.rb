...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = CivitaiOmni.make_runner(TEST_JSON_FILE, CivitaiSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : CivitaiOmni.errify(err)
    end
