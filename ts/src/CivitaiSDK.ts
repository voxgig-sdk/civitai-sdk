...
class CivitaiSDK {
  ...
  async graphql(query: string, variables?: any, ctrl?: any) {
    ...
    if (null != errors && Array.isArray(errors) && 0 < errors.length) {
      ...
      const err: any = new Error('CivitaiSDK: graphql: ' +
  ...
  Creator(entopts?: Record<string, any>) {
    const self = this
    return new CreatorEntity(self, entopts)
  }
  ...
  // The argument is the entity OPTIONS object (passed to the entity
  // constructor as entopts), not initial entity data.
  ModelVersion(entopts?: Record<string, any>) {
    const self = this
    return new ModelVersionEntity(self, entopts)
  }
