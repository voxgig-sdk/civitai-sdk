...
class CreatorEntity extends CivitaiEntityBase_1.CivitaiEntityBase {
    ...
    make() {
        return new CreatorEntity(this._client, this.entopts());
    }
    async list(reqmatch, ctrl) {
        ...
        try {
            ...
            if (err) {
                ...
                // Promise<Creator[]> return stays clean under strict null checks.
                return undefined;
            }
        }
    }
}
exports.CreatorEntity = CreatorEntity;
//# sourceMappingURL=CreatorEntity.js.map