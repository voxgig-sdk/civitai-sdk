...
(0, node_test_1.describe)('CreatorDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-creator', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-creator', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CIVITAI_TEST_CREATOR_ENTID'];
...
//# sourceMappingURL=CreatorDirect.test.js.map