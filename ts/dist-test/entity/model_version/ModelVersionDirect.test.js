...
(0, node_test_1.describe)('ModelVersionDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-model_version', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-model_version', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["hash01"]))
            return;
...
function liveScenariosActive() { return false && process.env.CIVITAI_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.CivitaiSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.CIVITAI_APIKEY,
        }));
        let idmap = env['CIVITAI_TEST_MODEL_VERSION_ENTID'];
    ...
    const client = new __1.CivitaiSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=ModelVersionDirect.test.js.map