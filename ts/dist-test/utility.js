...
function envOverride(m) {
    if ('TRUE' === process.env.CIVITAI_TEST_LIVE ||
        'TRUE' === process.env.CIVITAI_TEST_OVERRIDE) {
    ...
    m.CIVITAI_TEST_EXPLAIN = process.env.CIVITAI_TEST_EXPLAIN || m.CIVITAI_TEST_EXPLAIN;
    return m;
}
