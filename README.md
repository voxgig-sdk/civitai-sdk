...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/civitai` | `npm install @voxgig-sdk/civitai` |
| Python | `voxgig-sdk-civitai` | `pip install voxgig-sdk-civitai` |
| PHP | `voxgig-sdk/civitai` | `composer require voxgig-sdk/civitai` |
| Golang | `github.com/voxgig-sdk/civitai-sdk/go` | `go get github.com/voxgig-sdk/civitai-sdk/go` |
| Ruby | `voxgig-sdk-civitai` | `gem install voxgig-sdk-civitai` |
| Lua | `voxgig-sdk-civitai` | `luarocks install voxgig-sdk-civitai` |
