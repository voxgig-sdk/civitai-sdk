...
class CreatorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CreatorEntity($this->_client, $opts);
    }

    /**
     * @param Creator|array $args Creator data (assoc-array) to store.
     */
    ...
    /**
     * @return Creator|array The current Creator data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Creator fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Creator fields).
     */
     ...
     *
     * @param CreatorListMatch|array|null $reqmatch Match filter (any subset
     *   of Creator fields) as an assoc-array; CreatorListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Creator[]|array A list of Creator items as assoc-arrays at
