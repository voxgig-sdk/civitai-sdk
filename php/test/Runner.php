...
class CivitaiTestRunner
{
    ...
    {
        $live = self::getenv('CIVITAI_TEST_LIVE');
        $override = self::getenv('CIVITAI_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CIVITAI_TEST_EXPLAIN');
...
class_alias('CivitaiTestRunner', 'Runner');
class_alias('CivitaiHelpers', 'Helpers');
