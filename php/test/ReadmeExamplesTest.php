...
// Civitai SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (CivitaiSDK::test)
...
{
    private const SDK_CLASS = 'CivitaiSDK';
    ...
    private const SDK_BASE = 'civitai_sdk';
