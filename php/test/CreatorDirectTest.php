...
class CreatorDirectTest extends TestCase
{
    public function test_direct_list_creator(): void
    {
        $setup = creator_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-creator", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
