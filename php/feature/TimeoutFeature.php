...
class CivitaiTimeoutFeature extends CivitaiBaseFeature
{
    ...
    private function _with_timeout(CivitaiContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(CivitaiContext $_ctx, float $ms): void
    {
        $client = $this->client;
