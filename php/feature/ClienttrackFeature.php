...
// Civitai SDK clienttrack feature
...
class CivitaiClienttrackFeature extends CivitaiBaseFeature
{
    ...
    public function PostConstruct(CivitaiContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Civitai-SDK';
