...
class CivitaiProxyFeature extends CivitaiBaseFeature
{
    ...
    public function init(CivitaiContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (CivitaiContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
