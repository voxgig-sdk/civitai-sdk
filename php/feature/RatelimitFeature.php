...
class CivitaiRatelimitFeature extends CivitaiBaseFeature
{
    ...
    private function _acquire(CivitaiContext $ctx): void
    {
    ...
    private function _track(CivitaiContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
